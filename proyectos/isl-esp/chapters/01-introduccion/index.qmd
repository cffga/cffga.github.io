...
Sin embargo, los vectores que no son de longitud $n$ (como los vectores de características de longitud $p$, como en <a href="#eq-1-1" class="quarto-xref">(1.1)</a>) se denotarán en *redonda minúscula*, por ejemplo, $a$. Los escalares también se denotarán en *redonda minúscula*, por ejemplo, $a$. En los raros casos en que estos dos usos de la redonda minúscula puedan dar lugar a ambigüedad, aclararemos cuál es el uso pretendido. Las matrices se denotarán mediante *negritas mayúsculas*, como $\mathbf{A}$. Las variables aleatorias se denotarán usando *redonda mayúscula*, por ejemplo, $A$, independientemente de sus dimensiones.
